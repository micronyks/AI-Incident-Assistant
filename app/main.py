...
from app.core.startup import start_up
import logging
from app.api.routes.jira_webhook import router as jira_webhook_router
...
async def lifespan(app: FastAPI):
    """Lifespan event handler performing startup checks."""
    start_up()
    yield
...
app = FastAPI(
    ...
    lifespan=lifespan,  # Attach lifespan handler here
)
